/* FILE: kl_timeevolvervarms.cc                 -*-Mode: c++-*-
 *
 * See h-file
 *
 */
...
// Constructors
Klm_TimeEvolverVarMs::Klm_TimeEvolverVarMs
  ...
  : Oxs_Evolver(name,newdtr,argstr), energy_calc_count(0)
{
  total_energy_output.Setup(this,InstanceName(),
                            "Total energy","J",1,
                            &Klm_TimeEvolverVarMs::UpdateEnergyOutputs);
  ...
  energy_calc_count_output.Setup(this,InstanceName(),
                           "Energy calc count","",0,
                           &Klm_TimeEvolverVarMs::FillEnergyCalcCountOutput);
...
OC_BOOL Klm_TimeEvolverVarMs::Init()
{
#if REPORT_TIME
  Oc_TimeVal cpu,wall;
...
void Klm_TimeEvolverVarMs::GetEnergyDensity
...
void Klm_TimeEvolverVarMs::UpdateEnergyOutputs(const Oxs_SimState& state)
{
...
void Klm_TimeEvolverVarMs::FillEnergyCalcCountOutput(const Oxs_SimState& state)
{
